import java.io.*;
import java.util.*;
public class minimumnumberofsoftwaredevelopersofficial {
        ...
        public static void solution(int[] people, int nskills, int cp, ArrayList<Integer> onesol, int skills) {
            ...
            solution(people, nskills, cp + 1, onesol, skills);    //no
//agar banda yes karta hai
            onesol.add(cp);//iss bande ka index addd kar diya

//call
            solution(people, nskills, cp + 1, onesol, (skills | people[cp])); //purana mask or people of current person
//jaate jaate remove kar do
